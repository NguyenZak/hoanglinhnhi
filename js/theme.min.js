 ...
 * @version 2.4.0
 */
! function() { "use strict"; var e, t, r, a, n;
    (function() { var n, o = document.querySelectorAll(".masonry-grid"); if (null !== o)
        ...
        function() { var e = document.querySelectorAll('[data-bs-toggle="search"]'),
                t = document.querySelector(".navbar-search"); if (null !== t)
                for (var r = t.querySelector(".navbar-search-field"), a = 0; a < e.length; a++) e[a].addEventListener("click", function(e) { t.classList.toggle("show"), r.focus(), e.preventDefault() }) }(),
        ...
        function() { var e = document.querySelectorAll(".gallery"); if (e.length)
                for (var t = 0; t < e.length; t++) lightGallery(e[t], { selector: ".gallery-item", download: !1, videojs: !0, youtubePlayerParams: { modestbranding: 1, showinfo: 0, rel: 0 }, vimeoPlayerParams: { byline: 0, portrait: 0, color: "766df4" } }) }(),
        ...
        function(e, t, r) { for (var a = 0; a < e.length; a++) t.call(r, a, e[a]) }(document.querySelectorAll(".tns-carousel-wrapper .tns-carousel-inner"), function(e, t) { var r = { container: t, controlsText: ['<i class="ai-arrow-left"></i>', '<i class="ai-arrow-right"></i>'], navPosition: "top", controlsPosition: "top", mouseDrag: !0, speed: 600, autoplayHoverPause: !0, autoplayButtonOutput: !1 };
            null != t.dataset.carouselOptions && (n = JSON.parse(t.dataset.carouselOptions)); var r = _objectSpread(_objectSpread({}, r), n),
                a = tns(r),
                n = t.closest(".tns-carousel-wrapper"),
                o = n.querySelectorAll(".tns-item"),
                l = n.querySelector(".tns-carousel-pager"); if (null != l) { for (var s = l.querySelectorAll("[data-goto]"), c = 0; c < s.length; c++) s[c].addEventListener("click", function(e) { a.goTo(this.dataset.goto - 1), e.preventDefault() });
                a.events.on("indexChanged", function() { for (var e = a.getInfo(), t = 0; t < s.length; t++) s[t].classList.remove("active");
                    l.querySelector('[data-goto="' + e.displayIndex + '"]').classList.add("active") }) } var i, d, u = n.querySelector(".tns-carousel-label");
            null != u && a.events.on("indexChanged", function() { var e = a.getInfo(),
                    e = o[e.index].dataset.carouselLabel;
                u.innerHTML = e }), null !== n.querySelector(".tns-carousel-progress") && (r = a.getInfo(), i = n.querySelector(".tns-current-slide"), t = n.querySelector(".tns-total-slides"), d = n.querySelector(".tns-carousel-progress .progress-bar"), i.innerHTML = r.displayIndex, t.innerHTML = r.slideCount, d.style.width = r.displayIndex / r.slideCount * 100 + "%", a.events.on("indexChanged", function() { var e = a.getInfo();
                i.innerHTML = e.displayIndex, d.style.width = e.displayIndex / e.slideCount * 100 + "%" })) }),
        function() {
            function o(e, t) { return e + t } var e = document.querySelectorAll("[data-line-chart]"),
                t = document.querySelectorAll("[data-bar-chart]"),
                l = document.querySelectorAll("[data-pie-chart]"); if (0 !== e.length || 0 !== t.length || 0 !== l.length) { var s, r = document.head || document.getElementsByTagName("head")[0],
                    c = document.createElement("style");
                r.appendChild(c); for (var a = 0; a < e.length; a++) { var n, i = JSON.parse(e[a].dataset.lineChart),
                        d = null != e[a].dataset.options ? JSON.parse(e[a].dataset.options) : "",
                        u = e[a].dataset.seriesColor; if (e[a].classList.add("line-chart-" + a), null != u) { n = JSON.parse(u); for (var f = 0; f < n.colors.length; f++) s = "\n          .line-chart-".concat(a, " .ct-series:nth-child(").concat(f + 1, ") .ct-line,\n          .line-chart-").concat(a, " .ct-series:nth-child(").concat(f + 1, ") .ct-point {\n            stroke: ").concat(n.colors[f], " !important;\n          }\n        "), c.appendChild(document.createTextNode(s)) }
                    new Chartist.Line(e[a], i, d) } for (var v = 0; v < t.length; v++) { var p, m = JSON.parse(t[v].dataset.barChart),
                        h = null != t[v].dataset.options ? JSON.parse(t[v].dataset.options) : "",
                        g = t[v].dataset.seriesColor; if (t[v].classList.add("bar-chart-" + v), null != g) { p = JSON.parse(g); for (var y = 0; y < p.colors.length; y++) s = "\n        .bar-chart-".concat(v, " .ct-series:nth-child(").concat(y + 1, ") .ct-bar {\n            stroke: ").concat(p.colors[y], " !important;\n          }\n        "), c.appendChild(document.createTextNode(s)) }
                    new Chartist.Bar(t[v], m, h) } for (var b = 0; b < l.length; b++) ! function(e) { var t, r = JSON.parse(l[e].dataset.pieChart),
                        a = l[e].dataset.seriesColor; if (l[e].classList.add("cz-pie-chart-" + e), null != a) { t = JSON.parse(a); for (var n = 0; n < t.colors.length; n++) s = "\n        .cz-pie-chart-".concat(e, " .ct-series:nth-child(").concat(n + 1, ") .ct-slice-pie {\n            fill: ").concat(t.colors[n], " !important;\n          }\n        "), c.appendChild(document.createTextNode(s)) }
                    new Chartist.Pie(l[e], r, { labelInterpolationFnc: function(e) { return Math.round(e / r.series.reduce(o) * 100) + "%" } }) }(b) } }(),
        function() { var d = document.querySelectorAll(".countdown"); if (null != d)
                for (var e = 0; e < d.length; e++) { var t = function(e) { var t, r, a, n, o = d[e].dataset.countdown,
                        ...
                        setInterval(function() { var e = (new Date).getTime(),
                                e = parseInt((o - e) / 1e3);
                            0 <= e && (t = parseInt(e / 86400), e %= 86400, r = parseInt(e / 3600), e %= 3600, a = parseInt(e / 60), e %= 60, n = parseInt(e), null != l && (l.innerHTML = parseInt(t, 10)), null != s && (s.innerHTML = r < 10 ? "0" + r : r), null != c && (c.innerHTML = a < 10 ? "0" + a : a), null != i && (i.innerHTML = n < 10 ? "0" + n : n)) }, 1e3) }(e); if ("object" === _typeof(t)) return t.v } }(),
        function() { var e = document.querySelectorAll(".date-picker"); if (0 !== e.length)
                for (var t = 0; t < e.length; t++) { var r = void 0;
                    null != e[t].dataset.datepickerOptions && (r = JSON.parse(e[t].dataset.datepickerOptions)); var a = e[t].classList.contains("date-range") ? { plugins: [new rangePlugin({ input: e[t].dataset.linkedInput })] } : "{}",
                        r = _objectSpread(_objectSpread(_objectSpread({}, { disableMobile: "true" }), a), r);
                    flatpickr(e[t], r) } }(),
        function() { for (var e = document.querySelectorAll('[data-bs-toggle="radioTab"]'), t = 0; t < e.length; t++) e[t].addEventListener("click", function() { var e = this.dataset.bsTarget;
                document.querySelector(this.dataset.bsParent).querySelectorAll(".radio-tab-pane").forEach(function(e) { e.classList.remove("active") }), document.querySelector(e).classList.add("active") }) }(),
        ...
        function() { var o = document.querySelectorAll(".pricing-wrap"); if (null !== o)
                for (var e = 0; e < o.length; e++) ! function(e) {
                    function t() { if (a.checked) { r.parentNode.classList.add("price-switch-on"); for (var e = 0; e < n.length; e++) n[e].innerHTML = n[e].dataset.newPrice } else { r.parentNode.classList.remove("price-switch-on"); for (var t = 0; t < n.length; t++) n[t].innerHTML = n[t].dataset.currentPrice } } var r = o[e].querySelector(".form-switch"),
        ...
        function() { var o = document.querySelectorAll(".product-gallery"); if (o.length)
                for (var e = 0; e < o.length; e++) ! function(r) { for (var a = o[r].querySelectorAll(".product-gallery-thumblist-item"), n = o[r].querySelectorAll(".product-gallery-preview-item"), e = 0; e < a.length; e++) a[e].addEventListener("click", t);

                    function t(e) { e.preventDefault(); for (var t = 0; t < a.length; t++) n[t].classList.remove("active"), a[t].classList.remove("active");
                        this.classList.add("active"), o[r].querySelector(this.getAttribute("href")).classList.add("active") } }(e) }(),
        function() { var e = document.querySelectorAll(".btn-video"); if (e.length)
                for (var t = 0; t < e.length; t++) lightGallery(e[t], { selector: "this", download: !1, videojs: !0, youtubePlayerParams: { modestbranding: 1, showinfo: 0, rel: 0 }, vimeoPlayerParams: { byline: 0, portrait: 0, color: "766df4" } }) }(),
        function() { for (var n = document.querySelectorAll(".range-slider"), e = 0; e < n.length; e++) ! function(e) { var t = n[e].querySelector(".range-slider-ui"),
                ...
                noUiSlider.create(t, { start: [e.dataStartMin, e.dataStartMax], connect: !0, step: e.dataStep, pips: { mode: "count", values: 5 }, tooltips: !0, range: { min: e.dataMin, max: e.dataMax }, format: { to: function(e) { return "$" + parseInt(e, 10) }, from: function(e) { return Number(e) } } }), t.noUiSlider.on("update", function(e, t) { e = (e = e[t]).replace(/\D/g, "");
        ...
        function() { var e = document.querySelectorAll("[data-checkbox-toggle-class]"); if (0 !== e.length)
                for (var t = 0; t < e.length; t++) e[t].addEventListener("change", function() { var e = document.querySelector(this.dataset.bsTarget),
                        t = this.dataset.checkboxToggleClass;
                    this.checked ? e.classList.add(t) : e.classList.remove(t) }) }(),
        function() { var e = document.querySelectorAll("[data-master-checkbox-for]"); if (0 !== e.length)
                for (var t = 0; t < e.length; t++) e[t].addEventListener("change", function() { var e = document.querySelector(this.dataset.masterCheckboxFor).querySelectorAll('input[type="checkbox"]'); if (this.checked)
